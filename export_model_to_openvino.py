...
model_path, dynamic, half, int8 = vars(args).values()

print(f"model: {model_path}, dynamic: {dynamic}, half: {half}, int8: {int8}")
model = YOLO(model_path)
model.export(format="openvino",dynamic=dynamic, half=half, int8=int8)
